    ...
    class Egg {
        ...
        draw(context){
            ...
            if (this.game.debug) {
                ...
                context.lineTo(this.game.mouse.x, this.game.mouse.y);
                context.stroke();
                const displayTimer = (this.hatchTimer * 0.003).toFixed(0);
        ...
        update() {
            ...
            this.game.enemies.forEach(enemy => {
                if (this.game.checkCollision(this, enemy)[0] && !this.game.gameOver) {
                    ...
                    for (let i = 0; i < 5; i++){
                        this.game.particles.push(new Spark(this.game, this.collisionX, this.collisionY, 'lightgreen'));
                    } 
                }
            })
        }
        ...
        render(context, deltaTime){
            ...
            if (this.score >= this.winningScore) {
                ...
                if (this.lostHatchlings <=5) {
                    message1 = "The children of the forest are safe !";
                    message2 = "I knew you could do it !";
                } else {
                    message1 = "The Grinchs kidnapped " + this.lostHatchlings + " children ...";
                    message2 = "... because of you"
                }
                context.font = '90px Bangers';
                context.fillText(message1, this.width * 0.5, this.height * 0.5 - 20);
                context.font = '50px Bangers';
                context.fillText(message2, this.width * 0.5, this.height * 0.5 + 30);
                context.fillText("Final score : " + this.score + "  -  Press 'R' to fight for the forest again !", this.width * 0.5, this.height * 0.5 + 80 );
                context.restore();
            }
        }
        checkCollision(a ,b ){
